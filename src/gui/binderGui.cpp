...
BinderGUI::BinderGUI(QWidget *parent)
  : QWidget(parent)
...
void BinderGUI::handleQuit()
{
  qDebug() << "BinderGUI: aboutToQuit";
}


BinderGUI::~BinderGUI()
{
  qDebug() << "BinderGUI: destructor";
}


void BinderGUI::buildUI()
{
...
void BinderGUI::onFeedbackClicked()
{
...
void BinderGUI::onProximityClosed()
{
...
void BinderGUI::handleProximityUpdate(QByteArray rawJson) {
...
/*
void BinderGUI::onRankMsgBoxButtonClicked()
{
  rankMsgBox->setVisible(false);
}
*/
...
void BinderGUI::onSendFeedbackFinished()
{
...
void BinderGUI::onRankedSpacesClosed()
{
  qDebug() << "handle closed proximity";
...
void BinderGUI::onSettingsClicked()
{
...
void BinderGUI::onSettingsClosed()
{
...
void BinderGUI::setPlacesEnabled(bool isEnabled)
{
...
void BinderGUI::setSubmitState(SubmitState _submit_state, int scanCount)
{
...
void BinderGUI::onlineStateChanged(bool _online)
{
  qDebug() << "BinderGUI network status changed " << _online;
...
void BinderGUI::setDaemonLabel(bool online)
{
...
void BinderGUI::onDaemonTimerTimeout () {
...
void BinderGUI::receivedDaemonMsg () {
...
void BinderGUI::requestLocationEstimate()
{
  qDebug() << "BinderGUI: request location estimate";

  QDBusMessage msg = QDBusMessage::createSignal("/", "com.nokia.moled", "GetLocationEstimate");
  QDBusConnection::systemBus().send(msg);
}

void BinderGUI::onConfirmClicked()
{
...
void BinderGUI::onSubmitClicked()
{
...
void BinderGUI::confirmBind(BindSource source) {
      // confirm bind
      QMessageBox bindBox;
...
void BinderGUI::sendBindMsg(BindSource source)
{
...
void BinderGUI::handleLocationEstimate(QString fqName)
{
...
void BinderGUI::refreshLastEstimate()
{
...
/*
void BinderGUI::onSpeedStatusChanged(Motion motion)
{
...
void BinderGUI::setWalkingLabel(bool isWalking)
{
  if (isWalking) {
...
/*
void BinderGUI::onWalkingTimeout()
{
...
void BinderGUI::handleLocationStats
